"""
DSSMS統合メインエントリーポイント - 究極極限軽量版
datetime、importlib除去版

Target: < 1.2ms import time
"""

# 絶対最小限インポート（datetime, importlib除去）
import sys
import os
...
class DSSMSIntegratedBacktester:
    """
    DSSMS統合バックテスター - 究極極限軽量版
    
    datetime, importlib除去で究極軽量化
    """
    ...
    def load_symbol_switch_manager(self):
        """必要時にSymbolSwitchManager をロード"""
