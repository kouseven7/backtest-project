...
if __name__ == "__main__":
    ...
    print("\n[TEST] DSSMS Task 2.3: 統合テストスイート")
    print("=" * 60)
    print(f"[OK] テスト実行完了: {results['tests_passed'] + results['tests_failed']} 件")
    print(f"[OK] 成功: {results['tests_passed']} 件")
    print(f"[ERROR] 失敗: {results['tests_failed']} 件")
    print(f"[CHART] 成功率: {results['success_rate']:.1%}")
