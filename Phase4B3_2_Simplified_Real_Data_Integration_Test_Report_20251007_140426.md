...
## 実行サマリー
- **実行日時**: 2025-10-07 14:04:26
- **Real Market Data統合テスト**: [ERROR] 失敗
...
- **file_age_minutes**: [OK] 5.0
- **file_size_bytes**: [OK] 7745
- **backtest_executed**: [OK] True
- **trades_generated**: [OK] 41
- **excel_output_created**: [OK] True
...
## バックテスト基本理念遵守確認
- **actual_backtest_execution**: [OK] True
- **signal_generation**: [OK] True
- **excel_output_capability**: [OK] True
- **real_data_compatibility**: [ERROR] False
