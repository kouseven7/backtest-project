...
### [ALERT] 重要発見: Problem 15（Critical）
...
|---------|----------|------------|--------|----------|
| **Problem 15** | **90%** | **2.0工数** | **45.0** | **[ALERT]Critical最優先** |
...
def main():
    """メイン実行"""
    print("[LIST] Excel出力問題調査完了レポート生成中...")
