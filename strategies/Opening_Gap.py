...
- 検証銘柄: 7203.T, 6758.T, 9984.T, 8306.T (4銘柄)
- 結果: 全銘柄で壊滅的な性能
  - 7203.T: 3.7%勝率, -231.46% P&L, 188取引
  - 6758.T: 16.7%勝率, -101.93% P&L, 138取引
  - 9984.T: 18.3%勝率, -153.55% P&L, 131取引
  - 8306.T: 19.1%勝率, -154.91% P&L, 194取引
- 結論: 2022-2024の市場環境では使用不可
