...
### **開発段階KPI**
- **コード品質**: 単体テストカバレッジ > 80%
- **パフォーマンス**: 50銘柄スクリーニング < 30秒
- **精度**: パーフェクトオーダー検出精度 > 99%

### **運用段階KPI**
- **銘柄選択精度**: 選択銘柄の30日後パフォーマンス > ベンチマーク
- **切替効率**: 不要な切替回数 < 月10回
- **システム可用性**: 稼働率 > 99.5%

### **ビジネスKPI**
- **収益性**: DSSMS vs 単一銘柄戦略の超過リターン > 年5%
- **リスク調整後**: シャープレシオ改善 > 0.3ポイント
- **ドローダウン**: 最大ドローダウン < 従来システムの80%
